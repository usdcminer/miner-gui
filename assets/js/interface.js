...
function buyEggs(ref, trx, callback){
	if(+trx > +usrBal) {
		alert("You don't have " + "USDC" + " in your wallet");
	}
	else if(+trx > +spend) {
		alert("Approve spending " + "USDC" + " first");
	} else {
